      ...
      <div className="key-features host-details">
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center gap">
            <span className="apps material-symbols-outlined">apps</span>Dedicated
            Workspace
          </p>
          <span className="span">
        ...
        <div className="gutter-bottom-small">
          <p className="p d-flex align-center gap">
            <span className="apps material-symbols-outlined">apps</span>Great Location
          </p>
          <span className="span">
        ...
        <p className="p d-flex align-center gap">
          <span className="apps material-symbols-outlined">apps</span>Free
        ...
        <div className="d-flex gap-xxl">
          <div className="d-flex direction-column">
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Kitchen
            </span>
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Free parking
              on premises
            </span>
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Dedicated
          ...
          <div className="d-flex direction-column">
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Wifi
            </span>
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Washing
              Machine
            </span>
            <span className="span d-flex align-center gap">
              <span className="apps material-symbols-outlined">apps</span>Patio or
              Balcony
            </span>
          </div>
        </div>
